...
Once installed, in the main file
...
From here, having created your own account, you need to monetise a new app, where you create a banner ad and a reward video ad.
For both you will get an ad id, which you need to copy and paste into the Ad.swift file where the placeholder "Your banner ad id" and "Your video ad id" are .
...
To quickly personalise the app without changing the gameplay i would suggest you to change :
    the color in the colorDictionary
    the bulletSize
    the bulletColor
